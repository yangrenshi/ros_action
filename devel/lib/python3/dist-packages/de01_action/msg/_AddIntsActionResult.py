...
"""autogenerated by genpy from de01_action/AddIntsActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionResult(genpy.Message):
  ...
  _type = "de01_action/AddIntsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','de01_action/AddIntsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = de01_action.msg.AddIntsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = de01_action.msg.AddIntsResult()
